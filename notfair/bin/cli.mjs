...
program
  .name("notfair")
  .description("Goal-driven, loop-powered marketing agents that chase your targets 24/7 — on top of Claude Code or Codex.")
...
program
  .command("stop")
  .description("Stop any running NotFair instances on this machine.")
  .action(() => {
    console.log("Stop is not implemented yet. Use Ctrl+C in the running terminal,");
    console.log("or kill the node process bound to your NotFair port.");
    process.exit(1);
  });
